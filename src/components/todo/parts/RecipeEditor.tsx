...
type Props = {
    ...
    /** ▼ 追加: プレビューモード（操作系を非表示・入力は読み取り専用） */
    isPreview?: boolean; // ← 追加
};
...
function AutoResizeTextarea({
    ...
    return (
        <textarea
            ...
            aria-readonly={readOnly} // ← 追加（アクセシビリティ）
        />
    );
}
