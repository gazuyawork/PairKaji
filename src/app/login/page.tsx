...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#5E5E5E] text-[20px] mb-[50px] font-sans">ログイン</p>
      ...
      <div className="w-full max-w-[320px] flex flex-col gap-4">
        ...
        <hr className="w-full border-t border-[#AAAAAA] opacity-30 my-10" />

        <button
          className="w-[340px] mb-[15px] p-[10px] text-white rounded-[10px] bg-[#FF6B6B] border border-[#AAAAAA] font-sans text-[16px]"
        >
          Googleでログイン
        </button>
