          ...
          <div className="fixed inset-x-0 bottom-26 z-[1000] pointer-events-none">
            <div className="mx-auto max-w-xl relative px-24 mb-12">
              <button
                ...
                className="absolute right-0 w-14 h-14 rounded-full text-white text-3xl font-bold bg-gradient-to-b from-[#FFC25A] to-[#FFA726] shadow-lg shadow-[#e18c3b]/60 ring-2 ring-white hover:scale-105 active:translate-y-[1px] transition-transform flex items-center justify-center pointer-events-auto mr-5"
                aria-label="新規タスク追加"
              >
                ＋
              </button>
