...
// AdsenseAd は 'use client' なコンポーネントですが、
// Server Component から通常 import で呼び出してOK（クライアント側で水和されます）
            ...
            <section className="mx-auto max-w-5xl px-4 pt-16 pb-10">
                <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <div className="w-full mt-6">
                        {/* ▼ AdSense: slot は管理画面で作成後のIDに置き換え */}
                        {/* <AdsenseAd slot="1234567890" /> */}
                        <AdsenseAd
                            slot="1234567890"
                            testMode
                            style={{ display: 'block', minHeight: 160, border: '1px dashed #ddd' }}
                        />
